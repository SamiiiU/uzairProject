...
const Hero_two = () => {
    ...
    return (
        <div className='w-full bg-white    px-2 xl:px-28 sm:px-20  2xl:px-80  pt-20   pb-20 z-10 flex  flex-col lg:flex-row gap-10 '>
            <div data-aos="fade-in" className='lg:w-1/2 w-full  lg:items-start md:items-center md:px-0 sm:px-10 px-4 space-y-4 items-start'>
                ...
                <button onClick={() => setIsFormVisible(true)} className='px-8 py-4 rounded-full bg-[#03618F] hover:bg-lightBlue transition-all  font-semibold  text-white'>Get a free Website audit today</button>
            </div>

            <div data-aos="fade-in" className=' lg:w-1/2 w-full flex justify-center sm:px-10 px-4' >

               <img src={'https://res.cloudinary.com/dmwykcrki/image/upload/v1748284184/web_page_pic-01_chidek.png'} alt="About" className=' sm:h-[400px] w-auto h-60'/>
            </div>
        </div>
    )
}
